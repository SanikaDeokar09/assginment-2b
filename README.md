...
git remote -v
```
Sets the new remote and verifies the remote URL.
...
## Conclusion:
This experiment demonstrates how to use Git commands to upload a local project to GitHub. It helps in version control and project management.
